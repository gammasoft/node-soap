...
Client.prototype._invoke = function(method, args, location, callback, options, extraHeaders) {
  var self = this,
    ...
    headers = {
      ...
      'Content-Type': "application/soap+xml" // Agora a SEFAZ/GO exige este Content-Type, antes era a linha de cima
    };
  ...
  xml = "<soap:Envelope " +
        ...
        "xmlns:soap=\"http://www.w3.org/2003/05/soap-envelope\" " + // Agora a SEFAZ/GO exige este Content-Type, antes era a linha de cima
